...
class NapicuDate {
    ...
    getShortMonthName(date) {
        return exports.NapicuDateConfig.months[date.getMonth()].slice(0, exports.NapicuDateConfig.shortNameLength);
    }
    /**
     * Get the day name
     * @param date
    ...
    getShortDayName(date) {
        return exports.NapicuDateConfig.days[date.getDay()].slice(0, exports.NapicuDateConfig.shortNameLength);
    }
    /**
     * Get the year
     * @param date
    ...
    static getLanguageShortsDays() {
        return exports.NapicuDateConfig.days.map((day) => day.slice(0, exports.NapicuDateConfig.shortNameLength));
    }
    /**
     * Get the short months
     */
    static getLanguageShortsMonths() {
        return exports.NapicuDateConfig.months.map((month) => month.slice(0, exports.NapicuDateConfig.shortNameLength));
    }
    /**
     * Get the current day
     */
